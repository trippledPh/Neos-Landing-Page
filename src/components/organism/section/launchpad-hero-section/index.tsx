    ...
    <section className="w-full flex flex-col justify-center items-center p-4 gap-6 mt-[100px] p-4  xl:flex-row xl:gap-8 xl:items-start lg:justify-start">
      <div className="flex flex-col justify-center items-center  gap-[48px] mb-[48px] md:items-center xl:items-start md:justify-center ">
        <div className="flex flex-col items-start gap-6 md:text-center md:justify-center md:items-center xl:text-left xl:justify-start xl:items-start">
          <h3 className="text-[52px] leading-[48px] text-left md:text-5xl md:leading-[56px] text-wrap text-center max-w-[600px] w-fit font-maxima-nouva font-thin md:text-center md:text-[80px] xl:text-left xl:leading-[72px] ">
