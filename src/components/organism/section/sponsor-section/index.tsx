const SponsorSection = () => {
  return (
    <section className="flex flex-col items-center justify-center gap-4">
      ...
      <div className="flex flex-col items-center justify-center gap-6 mb-12  md:flex-row md:mt-4 lg:gap-12">
        <span>
          <img
        ...
        <div className="flex flex-col gap-4 md:grid grid-cols-2 gap-4 lg:gap-8">
          <span>
